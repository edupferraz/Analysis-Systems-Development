...
- Introduction to hardware:
  - Hardware - Physical
  - Software - Cloud
- Binary prefixes - Names or symbols preceding bits and bytes.
  - IEC Standard - International Electrotechnical Commission.
- Input devices x Output devices.
- Computer components:
  - Case (Chassis)
  - Motherboard (MoBo):
    - Sockets, AGP Slot, PCI Slot
    - AT (older) and ATX:
      - AT: Limited interior space; Low air circulation; Shutdown on button press after OS message.
      - ATX: Addresses AT issues.
  - Cooler
  - Hard Disk (HD)
  - Graphics Card
  - Sound Card
...
- Text:
  - Shell: Linux command interpreter program; Case Sensitive.
  - File Extensions: Windows (Requires extension) Linux (Do not need).
